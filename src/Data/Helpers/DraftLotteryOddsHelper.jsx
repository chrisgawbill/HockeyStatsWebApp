const draftLotteryOddsHelper = () => {
      function createDraftLotteryOddsArray(initialStandings) {
        const draftLotteryOddsArray = Array();
    
        for (let i = 31; i > 10; i--) {
          const responseTeam = initialStandings[i];
          if (responseTeam.wildCardRank > 2) {
            const teamId = responseTeam.team.id;
            const teamImage = "https://www-league.nhlstatic.com/images/logos/teams-current-primary-light/" + teamId + ".svg";
            ...
            const teamInfo =
              teamDraftLotteryOdds + "(" + draftLotteryOddsTrend + ")";
            const fixedTeam = {
              id: i,
      ...
      return{
        createDraftLotteryOddsArray
      }
}
export default draftLotteryOddsHelper;