    ...
    <>
      ...
      <Container fluid className="schedule-page">
        ...
        {selectedDateGames.map((game: ScheduledGame) => {
          ...
          const homeLogo = game.homeLogo.replace(
            "_light.svg",
            `_${logoSuffix}.svg`,
          );
          const awayLogo = game.awayLogo.replace(
            "_light.svg",
            `_${logoSuffix}.svg`,
          );
          return (
                ...
                <Col className="vs">
                  ...
                  {game.homeScore !== undefined ? (
                    <>
                      ...
                      <span
                        className={`game-period-chip${game.periodType === "OT" || game.periodType === "SO" ? " overtime" : ""}`}
                      >
                        {game.periodType === "OT"
                          ? "F/OT"
                          : game.periodType === "SO"
              ...
              <Row className="game-details">
                ...
                <Col xs={12} sm={4} className="text-center">
                  <ButtonGroup className="md3-btn-group">
                    ...
                    <Button
                      className="btn btn-primary"
                      onClick={() => handleGameCenterClick(game.gameCenter)}
                    >
                      Game Center
                    </Button>
                  </ButtonGroup>
