...
export default function StatsLeaderModal({showModal, setShowStatsModal, statsLeaderData, statIndicator}:StatsLeaderModalProps){
    ...
    const COLUMNS= [
        ...
        {label: {statIndicator}, renderCell:(item:PlayerStatLeader)=>item.value},
    ];
    return(
        <div>
